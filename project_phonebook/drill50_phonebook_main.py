...
class ParentWindow(Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        self.master = master
        self.master.minsize(675,370) #(Height, Width)
        self.master.maxsize(675,370)
        ...
        helpmenu.add_separator()
        helpmenu.add_command(label="About Student Tracking") # add_command is a child menubar item of the add_cascde parent item
